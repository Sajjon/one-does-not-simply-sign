...
#[derive(Clone)]
pub struct TestSignDriver;

impl BaseUseFactorSourceDriver for TestSignDriver {
    fn supports(&self, _factor_source_kind: FactorSourceKind) -> bool {
        true
    }
}

#[async_trait::async_trait]
impl SignWithFactorSourceDriver for TestSignDriver {
